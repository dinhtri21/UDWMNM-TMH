        ...
        <div class="head__top">
            <div class="service-header">
                ...
                <div class="header-icons">
                    ...
                    @if(Auth::check())
                        <span class=" dropdown">
                            <a href=""><span class="header-icon dropdown animate-dropdown "><i class="far fa-user"> <span
                                            style="font-family:'Century Gothic';font-size:15px;">&nbsp
                                            {{Auth::user()->username}}</span></i></a>
                            <div class="dropdown-content " style="font-size: 15px;">
                                ...
                                <a href="{{route('logout')}}" data-toggle="tooltip" title="Log out"><i
                                        class="glyphicon glyphicon-log-out"></i>&nbsp Log Out</a>
                            </div>
                        </span>
                    @else
                                            ...
                                            <div class="dropdown-content">
                                                <div class="row makeup">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <a href="{{route('foundation')}}">Kem nền - Kem lót - Kem che
                                                            khuyết điểm</a>
                    ...
                    <div class="col-md-3">
                        <div class="nav__right">
                            <form action="{{route('search')}}" role="search" class="box">
                                ...
                                <button style="border:none; background-color:white; margin-right:15px;"><i
                                        class='fas fa-search' style='font-size:15px'></i></button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer">
                <div class="footer-left col-md-4">
                    <p class="about">
                        ...
                        Website bán hàng với các chức năng như xem danh sách sản phẩm, Danh sách sản phẩm theo từng
                        loại,chức năng mua hàng và xử lý đơn hàng, chức năng đăng nhập và đăng xuất, Xử lý tìm kiếm theo
                        tên và theo giá sản phẩm.
                    </p>
                    <br>
                    <div class="icons">
                ...
                <div class="footer-right col-md-4">
                    ...
                    <div class="googleMap">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.9176126980487!2d105.80578381464521!3d20.99593939427444!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135acbf0df2c0e5%3A0xd740a66998e1a0ed!2sVNU+University+of+Science!5e0!3m2!1sen!2s!4v1566118193929!5m2!1sen!2s"
